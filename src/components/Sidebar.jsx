    ...
    return (
        <div id="sidebar" className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
            ...
            <div id="sidebar-logo" classname="flex flex-col">
                <span id="logo-title" className="font-poppins-ExtraBoldItalic text-[48px] text-gray-900">
                ...
                <ul id="menu-list" className="space-y-3">
                    ...
                    <li>
	                    <NavLink id="menu-2"  to="/Orders" className={menuClass}>
                            <FaBuysellads className="mr-4 text-xl" />
                            Orders</NavLink>
	                  </li>
	                  <li>
            ...
            <div id="sidebar-footer" className="mt-auto">
                <div id="footer-card" className="bg-hijau px-4 py-2 rounded-md shadow-lg mb-10 flex items-center" >
                    <div id="footer-text" className="text-white text-sm">
                        ...
                        <div id="add-menu-button" className="flex justify-center items-center p-2 mt-3 bg-white rounded-md space-x-2 text-gray-600" >
                            <span>Add Menus</span>
                        </div>
                    </div>
