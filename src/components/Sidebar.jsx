  ...
  return (
    ...
    >
      ...
      <div id="sidebar-logo" classname="flex flex-col">
        <span
          id="logo-title"
          className="font-poppins-ExtraBoldItalic text-[48px] text-gray-900"
        >
          Sedap{" "}
      ...
      <div id="sidebar-footer" className="mt-auto">
        ...
        >
          <div id="footer-text" className="text-white text-sm">
            ...
            <div
              id="add-menu-button"
              className="flex justify-center items-center p-2 mt-3 bg-white rounded-md space-x-2 text-gray-600"
            >
              <span>Add Menus</span>
            </div>
          </div>
