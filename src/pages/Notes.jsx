...
export default function Notes() {
  ...
  // 1. Fungsi loadNotes ditaruh di level utama komponen
  ...
  // 2. useEffect dipanggil di level utama agar otomatis jalan saat page load
  useEffect(() => {
    loadNotes();
  }, []);
  ...
  // 3. handleSubmit sekarang fokus hanya untuk menangani submit data
